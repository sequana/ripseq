Sequana ripseq pipeline documentation
#####################################################

|version|, |today|, status: production

The **ripseq** pipeline is a `Sequana <https://github.com/sequana/sequana>`_ pipeline. You can find the source code 
on  `https://github.com/sequana/sequana_ripseq <https://github.com/sequana/sequana_ripseq/>`_. Would you have issues
